...
Set `PROGRAM_TIMEZONE` to a valid IANA timezone (for example `UTC`) and deploy the composite indexes before exercising parent list endpoints in the emulator.
